...
4. UNet : Segmentation model. this version of the model is not tested. it is an accurate build of the first UNet architecture with image cropping. A better model with minute adjustments are tested later.
